    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="container max-w-md px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-teal-700">Se connecter</h1>
            ...
            <Link href="/login/freelancer">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-center">
                  Connectez-vous en tant que freelancer pour trouver des projets
                </CardDescription>
              </CardHeader>
              <CardFooter>
          ...
          <Card className="cursor-pointer hover:border-teal-200 transition-colors">
            <Link href="/login/company">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-center">
                  Connectez-vous en tant qu'entreprise pour publier des projets
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Button className="w-full bg-teal-600 hover:bg-teal-700">Continuer</Button>
